...
class PatrolPath(models.Model):
    """Single shared drone patrol route (Design Analysis.md §4.1). Only one
...
class TelemetrySample(models.Model):
    ...
    (Design Analysis.md §4.1) — same retention, pruned by the same policy."""
